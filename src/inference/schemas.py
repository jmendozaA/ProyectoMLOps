...
class GenderType(str, Enum):  # Renombrado para evitar conflicto con el campo 'Gender'
    MALE = "Male"
    FEMALE = "Female"
...
class StudentInput(BaseModel):
    ...
    # Configuración unificada para Pydantic v2
...
class PredictionOutput(BaseModel):
    ...
    # Configuración unificada para Pydantic v2
    model_config = ConfigDict(
        protected_namespaces=(),  # Permite campos que empiezan con "model_"
        json_schema_extra={
            "example": {
                "prediction": 72.45,
